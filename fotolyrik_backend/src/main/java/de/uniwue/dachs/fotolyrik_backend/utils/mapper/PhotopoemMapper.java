...
public class PhotopoemMapper {
    ...
    public Photopoem PhotopoemDTOToPhotopoem(PhotopoemDTO photopoemDTO) {
        ...
        photopoem.setFoundIn(locationMapper.LocationDTOsToLocations(photopoemDTO.getLocations()));
    ...
    public PhotopoemDTO PhotopoemToPhotopoemDTO(Photopoem photopoem) {
        ...
        photopoemDTO.setLocations(locationMapper.LocationsToLocationDTOs(photopoem.getFoundIn()));
