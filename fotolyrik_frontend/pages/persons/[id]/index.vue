    ...
    <Card>
      <template #title>
        <div class="flex flex-row justify-between">
          <h1 class="text-3xl font-bold text-primary-blue outfit-headline">{{ person_item?.fullName || person_item?.pseudonyms[0] }}</h1>
          <PageToolbar
              v-if="person_item"
              :id="person_item.id"
              entity_type="person"
      ...
      <template #content>
        ...
        <div class="flex flex-col gap-2">
          <div v-if="author_photopoems.length > 0" class="max-h-[30vh] flex flex-col gap-2">
            <h2 class="text-xl font-bold text-primary-blue outfit-headline">Autor:in von</h2>
          ...
          <div v-if="photographer_photopoems.length > 0" class="max-h-[30vh] flex flex-col gap-2">
            <h2 class="text-xl font-bold text-primary-blue outfit-headline">Fotograf:in von</h2>
            <div class="overflow-y-auto pb-2">
              <div class="flex flex-col gap-3 md:grid md:grid-cols-5">
          ...
          <div v-if="contributor_photopoems.length > 0" class="max-h-[30vh] flex flex-col gap-2">
            <h2 class="text-xl font-bold text-primary-blue outfit-headline">Mitgewirkt an</h2>
            <div class="overflow-y-auto pb-2">
              <div class="flex flex-col gap-3 md:grid md:grid-cols-5">
      ...
      <div class="previus">
        <div v-if="previous_person" class="p-2 border border-solid rounded-md hover:shadow-md">
          ...
          >
            ...
            <div class="text-primary-blue roboto-plain">Vorheriger Eintrag</div>
          </NuxtLink>
        </div>
      </div>
      <div class="next">
        <div v-if="next_person" class="p-2 border border-solid rounded-md hover:shadow-md">
          <NuxtLink
              ...
              class="flex flex-row items-center space-x-2"
          >
            <div class="text-primary-blue roboto-plain">Nächster Eintrag</div>
