    ...
    <Card>
      <template #title>
        <div class="flex flex-row justify-between">
          <h1 class="text-3xl font-bold text-primary-blue outfit-headline">{{ pub_medium_item?.title }}</h1>
          <PageToolbar
      ...
      <template #footer>
        <div v-if="pub_medium_photopoems.length > 0" class="max-h-[30vh] flex flex-col gap-2">
          <h2 class="text-xl font-bold text-primary-blue outfit-headline">Fotogedichte in "{{ pub_medium_item?.title }}"</h2>
